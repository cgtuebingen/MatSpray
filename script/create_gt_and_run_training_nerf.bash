...
# Base directories
root_dir="${ROOT_DIR:-/path/to/datasets/nerf_synthetic/}"
output_dir="${OUTPUT_DIR:-/path/to/results/nerf_synthetic/}"

# List of nerf_synthetic datasets (based on available blend files)
