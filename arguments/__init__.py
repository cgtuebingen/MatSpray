...
class PipelineParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.save_timelapse = True
        self.timelapse_interval = 10
        self.timelapse_fps = 10
        self.timelapse_camera_index = 0
        self.enable_timelapse = False
        self.use_dynamic_timelapse = True
        self.timelapse_interval_early = 5
        self.timelapse_interval_mid = 10
        self.timelapse_interval_late = 50
        self.timelapse_interval_final = 100
        self.timelapse_breakpoint_1 = 1000
        self.timelapse_breakpoint_2 = 3000
        self.timelapse_breakpoint_3 = 10000
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.lambda_base_color_buffer = 0.0
        self.lambda_roughness_buffer = 0.0
        self.lambda_metallic_buffer = 0.0
        self.lambda_diffuse_buffer = 0.0

        # Add new boolean parameters for controlling detachment
        self.detach_base_color = False
        self.detach_roughness = False
        self.detach_metallic = False

        # Freeze geometry gradients (xyz, scales, rotations, opacity)
        self.freeze_geometry = False

        # Diagnostics for parameter/gradient printing
        self.print_param_grads = False
        self.param_grads_interval = 100
